  ...
  public: {
    Tables: {
      account: {
        ...
        Relationships: [
          {
            foreignKeyName: "account_member_id_fkey"
            columns: ["member_id"]
      ...
      bank_account: {
        ...
        Relationships: [
          {
            foreignKeyName: "bank_account_account_id_fkey"
            columns: ["account_id"]
      ...
      goal: {
        ...
        Relationships: [
          {
            foreignKeyName: "goal_notification_id_fkey"
      ...
      grocery_item: {
        ...
        Relationships: [
          {
            foreignKeyName: "grocery_item_column_id_fkey"
            columns: ["column_id"]
      ...
      grocery_list: {
        ...
        Relationships: [
          {
            foreignKeyName: "grocery_list_grocery_items_fkey"
            columns: ["grocery_items"]
            referencedRelation: "grocery_item"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "grocery_list_recipe_items_fkey"
            columns: ["recipe_items"]
